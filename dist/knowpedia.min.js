...
/*!
   ...
   */
(function(){function _typeof(obj){"@babel/helpers - typeof";if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj}}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj}}return _typeof(obj)}var rotate=function rotate(cx,cy,deg,x,y){var cos=Math.cos(deg),sin=Math.sin(deg);return[+((x-cx)*cos-(y-cy)*sin+cx).toFixed(7),+((x-cx)*sin+(y-cy)*cos+cy).toFixed(7)]};function arc(beginA,rotateA,cx,cy,r1,r2,doback){if(rotateA<0){beginA+=rotateA;rotateA*=-1}var temp=[],p;p=rotate(0,0,beginA,r1,0);temp[0]=p[0];temp[1]=p[1];p=rotate(0,0,rotateA,p[0],p[1]);temp[2]=p[0];temp[3]=p[1];p=rotate(0,0,beginA,r2,0);temp[4]=p[0];temp[5]=p[1];p=rotate(0,0,rotateA,p[0],p[1]);temp[6]=p[0];temp[7]=p[1];doback(beginA,beginA+rotateA,temp[0]+cx,temp[1]+cy,temp[4]+cx,temp[5]+cy,temp[2]+cx,temp[3]+cy,temp[6]+cx,temp[7]+cy,(r2-r1)*.5)}var initPainterConfig={fillStyle:"black",strokeStyle:"black",lineWidth:1,textAlign:"left",textBaseline:"middle","font-size":16,"font-family":"sans-serif","arc-start-cap":"butt","arc-end-cap":"butt",lineDash:[],shadowBlur:0,shadowColor:"black"};var initText=function initText(painter,config,x,y,deg,platform){painter.beginPath();painter.translate(x,y);painter.rotate(deg);if(platform!="web"){painter.setFontSize(config["font-size"])}else{painter.font=config["font-size"]+"px "+config["font-family"]}return painter};var initArc=function initArc(painter,config,cx,cy,r1,r2,beginDeg,deg){if(r1>r2){var temp=r1;r1=r2;r2=temp}beginDeg=beginDeg%(Math.PI*2);if(deg>=Math.PI*1.999999||deg<=-Math.PI*1.999999){deg=Math.PI*2}else{deg=deg%(Math.PI*2)}arc(beginDeg,deg,cx,cy,r1,r2,(function(beginA,endA,begInnerX,begInnerY,begOuterX,begOuterY,endInnerX,endInnerY,endOuterX,endOuterY,r){if(r<0)r=-r;painter.beginPath();painter.moveTo(begInnerX,begInnerY);painter.arc(cx,cy,r1,beginA,endA,false);if(config["arc-end-cap"]!="round")painter.lineTo(endOuterX,endOuterY);else painter.arc((endInnerX+endOuterX)*.5,(endInnerY+endOuterY)*.5,r,endA-Math.PI,endA,true);painter.arc(cx,cy,r2,endA,beginA,true);if(config["arc-start-cap"]!="round")painter.lineTo(begInnerX,begInnerY);else painter.arc((begInnerX+begOuterX)*.5,(begInnerY+begOuterY)*.5,r,beginA,beginA-Math.PI,true)}));if(config["arc-start-cap"]=="butt")painter.closePath();return painter};var initCircle=function initCircle(painter,cx,cy,r){painter.beginPath();painter.moveTo(cx+r,cy);painter.arc(cx,cy,r,0,Math.PI*2);return painter};var initRect=function initRect(painter,x,y,width,height){painter.beginPath();painter.rect(x,y,width,height);return painter};var linearGradient=function linearGradient(painter,x0,y0,x1,y1){var gradient=painter.createLinearGradient(x0,y0,x1,y1);var enhanceGradient={value:function value(){return gradient},addColorStop:function addColorStop(stop,color){gradient.addColorStop(stop,color);return enhanceGradient}};return enhanceGradient};var radialGradient=function radialGradient(painter,cx,cy,r){var gradient=painter.createRadialGradient(cx,cy,0,cx,cy,r);var enhanceGradient={value:function value(){return gradient},addColorStop:function addColorStop(stop,color){gradient.addColorStop(stop,color);return enhanceGradient}};return enhanceGradient};var unSupportAttr={};function painterFactory(painter,platform){var config={};var useConfig=platform=="uni-app"?function(key,value){if(["font-size","font-family","arc-start-cap","arc-end-cap"].indexOf(key)>-1){config[key]=value}else{try{painter["set"+key[0].toUpperCase()+key.substr(1)](value)}catch(e){if(!unSupportAttr[platform]){unSupportAttr[platform]={}}if(!unSupportAttr[platform][key]){unSupportAttr[platform][key]=true;console.warn("内置画笔的"+key+"属性在"+platform+"平台上不支持！")}}}}:function(key,value){if(key=="lineDash"){painter.setLineDash(value)}else if(["font-size","font-family","arc-start-cap","arc-end-cap"].indexOf(key)>-1){config[key]=value}else if(key in initPainterConfig){painter[key]=value}else{throw new Error("Illegal configuration item of painter : "+key+" !")}};var enhancePainter={config:function config(){if(arguments.length===1){if(_typeof(arguments[0])!=="object")return painter[arguments[0]];for(var key in arguments[0]){useConfig(key,arguments[0][key])}}else if(arguments.length===2){useConfig(arguments[0],arguments[1])}return enhancePainter},fillText:function fillText(text,x,y,deg){painter.save();initText(painter,config,x,y,deg||0,platform).fillText(text,0,0);painter.restore();return enhancePainter},strokeText:function strokeText(text,x,y,deg){painter.save();initText(painter,config,x,y,deg||0,platform).strokeText(text,0,0);painter.restore();return enhancePainter},fullText:function fullText(text,x,y,deg){painter.save();initText(painter,config,x,y,deg||0,platform);painter.fillText(text,0,0);painter.strokeText(text,0,0);painter.restore();return enhancePainter},beginPath:function beginPath(){painter.beginPath();return enhancePainter},closePath:function closePath(){painter.closePath();return enhancePainter},moveTo:function moveTo(x,y){painter.moveTo(x,y);return enhancePainter},lineTo:function lineTo(x,y){painter.lineTo(x,y);return enhancePainter},arc:function arc(x,y,r,beginDeg,deg){painter.arc(x,y,r,beginDeg,beginDeg+deg,deg<0);return enhancePainter},fill:function fill(){painter.fill();return enhancePainter},stroke:function stroke(){painter.stroke();return enhancePainter},full:function full(){painter.fill();painter.stroke();return enhancePainter},save:function save(){painter.save();return enhancePainter},restore:function restore(){painter.restore();return enhancePainter},quadraticCurveTo:function quadraticCurveTo(cpx,cpy,x,y){painter.quadraticCurveTo(cpx,cpy,x,y);return enhancePainter},bezierCurveTo:function bezierCurveTo(cp1x,cp1y,cp2x,cp2y,x,y){painter.bezierCurveTo(cp1x,cp1y,cp2x,cp2y,x,y);return enhancePainter},clearRect:function clearRect(x,y,w,h){painter.clearRect(x,y,w,h);return enhancePainter},fillArc:function fillArc(cx,cy,r1,r2,beginDeg,deg){initArc(painter,config,cx,cy,r1,r2,beginDeg,deg).fill();return enhancePainter},strokeArc:function strokeArc(cx,cy,r1,r2,beginDeg,deg){initArc(painter,config,cx,cy,r1,r2,beginDeg,deg).stroke();return enhancePainter},fullArc:function fullArc(cx,cy,r1,r2,beginDeg,deg){initArc(painter,config,cx,cy,r1,r2,beginDeg,deg);painter.fill();painter.stroke();return enhancePainter},fillCircle:function fillCircle(cx,cy,r){initCircle(painter,cx,cy,r).fill();return enhancePainter},strokeCircle:function strokeCircle(cx,cy,r){initCircle(painter,cx,cy,r).stroke();return enhancePainter},fullCircle:function fullCircle(cx,cy,r){initCircle(painter,cx,cy,r);painter.fill();painter.stroke();return enhancePainter},fillRect:function fillRect(x,y,width,height){initRect(painter,x,y,width,height).fill();return enhancePainter},strokeRect:function strokeRect(x,y,width,height){initRect(painter,x,y,width,height).stroke();return enhancePainter},fullRect:function fullRect(x,y,width,height){initRect(painter,x,y,width,height);painter.fill();painter.stroke();return enhancePainter},createLinearGradient:function createLinearGradient(x0,y0,x1,y1){return linearGradient(painter,x0,y0,x1,y1)},createRadialGradient:function createRadialGradient(cx,cy,r){return radialGradient(painter,cx,cy,r)}};if(platform=="uni-app")enhancePainter.draw=function(){painter.draw();return enhancePainter};return enhancePainter}var CrossEndCanvas=function CrossEndCanvas(config){return new Promise((function(resolve,reject){if(config.platform=="web"){var canvas=document.getElementById(config.id);var width=canvas.clientWidth,height=canvas.clientHeight;canvas.style.width=width+"px";canvas.style.height=height+"px";canvas.setAttribute("width",width*2);canvas.setAttribute("height",height*2);var painter=canvas.getContext("2d");painter.scale(2,2);resolve([painter,config.platform])}else if(config.platform=="uni-app"){resolve([uni.createCanvasContext(config.id,config.target),config.platform])}else if(config.platform=="weixin"){var dpr=wx.getSystemInfoSync().pixelRatio;wx.createSelectorQuery()["in"](config.target).select("#"+config.id).fields({node:true,size:true}).exec((function(res){var canvas=res[0].node;var painter=canvas.getContext("2d");canvas.width=res[0].width*dpr;canvas.height=res[0].height*dpr;painter.scale(dpr,dpr);resolve([painter,config.platform])}))}else{reject("你必须配置一个合法的平台")}})).then((function(data){return painterFactory(data[0],data[1])}))};if(_typeof(module)==="object"&&_typeof(module.exports)==="object"){module.exports=CrossEndCanvas}else{window.CrossEndCanvas=CrossEndCanvas}})()}));var config={mathFormula:{"font-size":12,"padding-size":3}};var drawBracket=function drawBracket(painter,type,position,x,y,size){if(type=="small"){if(position=="left"){painter.beginPath().moveTo(x+10,y).quadraticCurveTo(x,y+size*.5,x+10,y+size).stroke()}else if(position="right"){painter.beginPath().moveTo(x,y).quadraticCurveTo(x+10,y+size*.5,x,y+size).stroke()}}else if(type=="middle"){if(position=="left"){painter.beginPath().lineTo(x+10,y).lineTo(x+5,y).lineTo(x+5,y+size).lineTo(x+10,y+size).stroke()}else if(position="right"){painter.beginPath().lineTo(x,y).lineTo(x+5,y).lineTo(x+5,y+size).lineTo(x,y+size).stroke()}}else if(type=="big"){if(position=="left"){painter.beginPath().lineTo(x+10,y).lineTo(x+5,y+3).lineTo(x+5,y+size*.5-3).lineTo(x+2,y+size*.5).lineTo(x+5,y+size*.5+3).lineTo(x+5,y+size-3).lineTo(x+10,y+size).stroke()}else if(position="right"){painter.beginPath().lineTo(x,y).lineTo(x+5,y+3).lineTo(x+5,y+size*.5-3).lineTo(x+7,y+size*.5).lineTo(x+5,y+size*.5+3).lineTo(x+5,y+size-3).lineTo(x,y+size).stroke()}}};var index=0;var doit=function doit(el,binding){var id="kp-math-formula-id-"+index++;var mathFormulaData=binding.value;if(!mathFormulaData)return;el.innerHTML="<canvas id='"+id+"' style='width:"+mathFormulaData.width+"px;height:"+mathFormulaData.height+"px;vertical-align: middle;'>非常抱歉，您的浏览器不支持canvas!</canvas>";crossEndCanvas_min({id:id,platform:"web"}).then((function(painter){painter.config({textAlign:"center",textBaseline:"middle","font-size":config.mathFormula["font-size"]});var drawFormula=function drawFormula(x,y,data){switch(data.type){case"string":{painter.fillText(data.contents[0],x+data.width*.5,y+data.height*.5);break}case"gen":{drawFormula(x+5+config.mathFormula["padding-size"],y+config.mathFormula["padding-size"],data.contents[0]);painter.beginPath().lineTo(x+config.mathFormula["padding-size"],y+data.height-config.mathFormula["padding-size"]).lineTo(x+config.mathFormula["padding-size"]+2.5,y+data.height-config.mathFormula["padding-size"]-2.5).lineTo(x+config.mathFormula["padding-size"]+5,y+data.height-config.mathFormula["padding-size"]).lineTo(x+config.mathFormula["padding-size"]+5,y+config.mathFormula["padding-size"]*.5).lineTo(x+data.width-config.mathFormula["padding-size"],y+config.mathFormula["padding-size"]*.5).stroke();break}case"limt":{var leftTop=y+data.contents[1].height*.5-data._help.limtSize.height*.5;painter.fillText("lim",x+config.mathFormula["padding-size"]+data._help.leftWidth*.5,config.mathFormula["padding-size"]+leftTop);drawFormula(x,data._help.limtSize.height+leftTop-config.mathFormula["padding-size"],data.contents[0]);drawFormula(x+config.mathFormula["padding-size"]+data._help.leftWidth,y,data.contents[1]);break}case"sum":{drawFormula(x+data._help.leftWidth*.5-data._help.p1Width*.5+config.mathFormula["padding-size"],y+data.height*.5+10+config.mathFormula["padding-size"],data.contents[0]);painter.beginPath().lineTo(x+data._help.leftWidth*.5+10+config.mathFormula["padding-size"],y+data.height*.5-10+config.mathFormula["padding-size"]).lineTo(x+data._help.leftWidth*.5-10+config.mathFormula["padding-size"],y+data.height*.5-10+config.mathFormula["padding-size"]).lineTo(x+data._help.leftWidth*.5+7+config.mathFormula["padding-size"],y+data.height*.5+config.mathFormula["padding-size"]).lineTo(x+data._help.leftWidth*.5-10+config.mathFormula["padding-size"],y+data.height*.5+10+config.mathFormula["padding-size"]).lineTo(x+data._help.leftWidth*.5+10+config.mathFormula["padding-size"],y+data.height*.5+10+config.mathFormula["padding-size"]).stroke();drawFormula(x+data._help.leftWidth*.5-data._help.p2Width*.5+config.mathFormula["padding-size"],y+data.height*.5-10-data._help.p2Height+config.mathFormula["padding-size"],data.contents[1]);drawFormula(x+data._help.leftWidth+config.mathFormula["padding-size"],y+data.height*.5-data._help.rightHeight*.5,data.contents[2]);break}case"join":{var _iterator=_createForOfIteratorHelper(data.contents),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var item=_step.value;drawFormula(x+config.mathFormula["padding-size"],y-item.height*.5+data.height*.5,item);x+=item.width}}catch(err){_iterator.e(err)}finally{_iterator.f()}break}case"matrix":{for(var i in data.contents){for(var j in data.contents[i]){var curData=data.contents[i][j];if(curData.contents[0]=="|"){painter.beginPath().lineTo(x+data._help.colCenter[j],y+data._help.rowCenter[i]-curData.height*.5).lineTo(x+data._help.colCenter[j],y+data._help.rowCenter[i]+curData.height*.5).stroke()}else{drawFormula(x+data._help.colCenter[j]-curData.width*.5,y+data._help.rowCenter[i]-curData.height*.5,curData)}}}if(data._help.isHLS){painter.beginPath().lineTo(x+config.mathFormula["padding-size"]+5,y+config.mathFormula["padding-size"]).lineTo(x+config.mathFormula["padding-size"]+5,y+data.height-config.mathFormula["padding-size"]).stroke();painter.beginPath().lineTo(x-config.mathFormula["padding-size"]-5+data.width,y+config.mathFormula["padding-size"]).lineTo(x-config.mathFormula["padding-size"]-5+data.width,y+data.height-config.mathFormula["padding-size"]).stroke()}else{painter.beginPath().lineTo(x+config.mathFormula["padding-size"]+10,y+config.mathFormula["padding-size"]).lineTo(x+config.mathFormula["padding-size"]+5,y+config.mathFormula["padding-size"]+5).lineTo(x+config.mathFormula["padding-size"]+5,y+data.height-config.mathFormula["padding-size"]-5).lineTo(x+config.mathFormula["padding-size"]+10,y+data.height-config.mathFormula["padding-size"]).stroke();painter.beginPath().lineTo(x-config.mathFormula["padding-size"]-10+data.width,y+config.mathFormula["padding-size"]).lineTo(x-config.mathFormula["padding-size"]-5+data.width,y+config.mathFormula["padding-size"]+5).lineTo(x-config.mathFormula["padding-size"]-5+data.width,y+data.height-config.mathFormula["padding-size"]-5).lineTo(x-config.mathFormula["padding-size"]-10+data.width,y+data.height-config.mathFormula["padding-size"]).stroke()}break}case"division":{drawFormula(x+(data.width-data.contents[0].width)*.5,y+config.mathFormula["padding-size"],data.contents[0]);drawFormula(x+(data.width-data.contents[1].width)*.5,y+config.mathFormula["padding-size"]+data.contents[0].height+2,data.contents[1]);painter.beginPath().lineTo(x+config.mathFormula["padding-size"],y+data.contents[0].height+1).lineTo(x+data.width-config.mathFormula["padding-size"],y+data.contents[0].height+1).stroke();break}case"bracket":{drawFormula(x+config.mathFormula["padding-size"]+10,y+config.mathFormula["padding-size"],data.contents[0]);drawBracket(painter,data._help.type,"left",x+config.mathFormula["padding-size"],y+config.mathFormula["padding-size"],data.height-2*config.mathFormula["padding-size"]);drawBracket(painter,data._help.type,"right",x+data.width-config.mathFormula["padding-size"]-10,y+config.mathFormula["padding-size"],data.height-2*config.mathFormula["padding-size"]);break}case"rightTop":{drawFormula(x+.5*config.mathFormula["padding-size"],y+data.height-data._help.p1Height-config.mathFormula["padding-size"],data.contents[0]);drawFormula(x-1.5*config.mathFormula["padding-size"]+data._help.p1Width,y+.5*config.mathFormula["padding-size"],data.contents[1]);break}case"rightBottom":{drawFormula(x+.5*config.mathFormula["padding-size"],y+config.mathFormula["padding-size"],data.contents[0]);drawFormula(x-1.5*config.mathFormula["padding-size"]+data._help.p1Width,y+data.height-.5*config.mathFormula["padding-size"]-data._help.p2Height,data.contents[1]);break}case"equationSet":{drawBracket(painter,"big","left",x+config.mathFormula["padding-size"],y+config.mathFormula["padding-size"],data.height-2*config.mathFormula["padding-size"]);for(var _i in data.contents){drawFormula(x+config.mathFormula["padding-size"]+10,y+data._help.pxTops[_i],data.contents[_i])}break}case"upLine":{drawFormula(x,y+config.mathFormula["padding-size"],data.contents[0]);painter.beginPath().lineTo(x,y+config.mathFormula["padding-size"]).lineTo(x+data.width,y+config.mathFormula["padding-size"]).stroke();break}case"downLine":{drawFormula(x,y,data.contents[0]);painter.beginPath().lineTo(x,y+data.height-config.mathFormula["padding-size"]).lineTo(x+data.width,y+data.height-config.mathFormula["padding-size"]).stroke();break}case"absoluteValue":{drawFormula(x+config.mathFormula["padding-size"],y,data.contents[0]);painter.beginPath().lineTo(x+config.mathFormula["padding-size"],y).lineTo(x+config.mathFormula["padding-size"],y+data.height).stroke();painter.beginPath().lineTo(x+data.width-config.mathFormula["padding-size"],y).lineTo(x+data.width-config.mathFormula["padding-size"],y+data.height).stroke();break}case"integral":{drawFormula(x+config.mathFormula["padding-size"]+15,y+config.mathFormula["padding-size"],data.contents[3]);drawFormula(x+config.mathFormula["padding-size"]+10,y+data.height-data.contents[2].height-config.mathFormula["padding-size"],data.contents[2]);drawFormula(x+config.mathFormula["padding-size"]+15,y+config.mathFormula["padding-size"]+data.contents[3].height,data.contents[0]);drawFormula(x+config.mathFormula["padding-size"]+15+data.contents[0].width,y+config.mathFormula["padding-size"]+data.contents[3].height+.5*(data.contents[0].height-data.contents[1].height),data.contents[1]);painter.beginPath().moveTo(x+config.mathFormula["padding-size"],y+data.height-config.mathFormula["padding-size"]-2.5).arc(x+config.mathFormula["padding-size"]+2.5,y+data.height-config.mathFormula["padding-size"]-2.5,2.5,Math.PI,-Math.PI).lineTo(x+config.mathFormula["padding-size"]+10,y+config.mathFormula["padding-size"]+2.5).arc(x+config.mathFormula["padding-size"]+12.5,y+config.mathFormula["padding-size"]+2.5,2.5,Math.PI,Math.PI).stroke();break}case"listedOr":{drawFormula(x+data.width*.5-data.contents[0].width*.5,y+data.height-config.mathFormula["padding-size"]-data.contents[0].height,data.contents[0]);drawFormula(x+data.width*.5-data.contents[1].width*.5,y+config.mathFormula["padding-size"],data.contents[1]);painter.beginPath().moveTo(x+data.width*.5-15,y+config.mathFormula["padding-size"]+data.contents[1].height).lineTo(x+data.width*.5-15,y+config.mathFormula["padding-size"]+data.contents[1].height+25).bezierCurveTo(x+data.width*.5-10,y+config.mathFormula["padding-size"]+data.contents[1].height+30,x+data.width*.5+10,y+config.mathFormula["padding-size"]+data.contents[1].height+30,x+data.width*.5+15,y+config.mathFormula["padding-size"]+data.contents[1].height+25).lineTo(x+data.width*.5+15,y+config.mathFormula["padding-size"]+data.contents[1].height).stroke();break}case"listedAnd":{drawFormula(x+data.width*.5-data.contents[0].width*.5,y+data.height-config.mathFormula["padding-size"]-data.contents[0].height,data.contents[0]);drawFormula(x+data.width*.5-data.contents[1].width*.5,y+config.mathFormula["padding-size"],data.contents[1]);painter.beginPath().moveTo(x+data.width*.5-15,y+config.mathFormula["padding-size"]+data.contents[1].height+35).lineTo(x+data.width*.5-15,y+config.mathFormula["padding-size"]+data.contents[1].height+10).bezierCurveTo(x+data.width*.5-10,y+config.mathFormula["padding-size"]+data.contents[1].height+5,x+data.width*.5+10,y+config.mathFormula["padding-size"]+data.contents[1].height+5,x+data.width*.5+15,y+config.mathFormula["padding-size"]+data.contents[1].height+10).lineTo(x+data.width*.5+15,y+config.mathFormula["padding-size"]+data.contents[1].height+35).stroke();break}default:{console.error("未匹配的数据格式：");console.error(x,y,data)}}};drawFormula(0,0,mathFormulaData)}))};var kpMathFormula={inserted:function inserted(el,binding){doit(el,binding)},update:function update(el,binding){doit(el,binding)}};
/*!
 * 💡 - 提供常用的DOM操作方法
 ...
 * Released under the MIT license
 */var namespace={svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};var xhtml={stopPropagation:function stopPropagation(event){event=event||window.event;if(event.stopPropagation){event.stopPropagation()}else{event.cancelBubble=true}},preventDefault:function preventDefault(event){event=event||window.event;if(event.preventDefault){event.preventDefault()}else{event.returnValue=false}},isNode:function isNode(param){return param&&(param.nodeType===1||param.nodeType===9||param.nodeType===11)},bind:function bind(dom,eventType,callback){if(dom.constructor===Array||dom.constructor===NodeList||dom.constructor===HTMLCollection){for(var i=0;i<dom.length;i++){this.bind(dom[i],eventType,callback)}return}if(window.attachEvent)dom.attachEvent("on"+eventType,callback);else dom.addEventListener(eventType,callback,false)},unbind:function unbind(dom,eventType,handler){if(dom.constructor===Array||dom.constructor===NodeList||dom.constructor===HTMLCollection){for(var i=0;i<dom.length;i++){this.unbind(dom[i],eventType,handler)}return}if(window.detachEvent)dom.detachEvent("on"+eventType,handler);else dom.removeEventListener(eventType,handler,false)},find:function find(context,selectFun,tagName){if(!this.isNode(context))return[];var nodes=context.getElementsByTagName(tagName||"*");var result=[];for(var i=0;i<nodes.length;i++){if(this.isNode(nodes[i])&&(typeof selectFun!="function"||selectFun(nodes[i])))result.push(nodes[i])}return result},children:function children(dom,selectFun){var nodes=dom.childNodes;var result=[];for(var i=0;i<nodes.length;i++){if(this.isNode(nodes[i])&&(typeof selectFun!="function"||selectFun(nodes[i])))result.push(nodes[i])}return result},hasClass:function hasClass(dom,clazzs,notStrict){if(clazzs.constructor!==Array)clazzs=[clazzs];var class_str=" "+(dom.getAttribute("class")||"")+" ";for(var i=0;i<clazzs.length;i++){if(class_str.indexOf(" "+clazzs[i]+" ")>=0){if(notStrict)return true}else{if(!notStrict)return false}}return true},removeClass:function removeClass(dom,clazz){var oldClazz=" "+(dom.getAttribute("class")||"")+" ";var newClazz=oldClazz.replace(" "+clazz.trim()+" "," ");dom.setAttribute("class",newClazz.trim())},addClass:function addClass(dom,clazz){if(this.hasClass(dom,clazz))return;var oldClazz=dom.getAttribute("class")||"";dom.setAttribute("class",oldClazz+" "+clazz)},toNode:function toNode(template,isSvg){var frame;if(isSvg)frame=document.createElementNS(namespace.svg,"svg");else{var frameTagName="div";if(/^<tr[> ]/.test(template)){frameTagName="tbody"}else if(/^<th[> ]/.test(template)||/^<td[> ]/.test(template)){frameTagName="tr"}else if(/^<thead[> ]/.test(template)||/^<tbody[> ]/.test(template)){frameTagName="table"}frame=document.createElement(frameTagName)}frame.innerHTML=template;var childNodes=frame.childNodes;for(var i=0;i<childNodes.length;i++){if(this.isNode(childNodes[i]))return childNodes[i]}},trigger:function trigger(dom,eventType){if(document.createEventObject){dom.fireEvent("on"+eventType,document.createEventObject())}else{var _event=document.createEvent("HTMLEvents");_event.initEvent(eventType,true,false);dom.dispatchEvent(_event)}},getStyle:function getStyle(dom,name){var allStyle=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(dom,null):dom.currentStyle;return typeof name==="string"?allStyle.getPropertyValue(name):allStyle},offsetPosition:function offsetPosition(dom){var left=0;var top=0;top=dom.offsetTop;left=dom.offsetLeft;dom=dom.offsetParent;while(dom){top+=dom.offsetTop;left+=dom.offsetLeft;dom=dom.offsetParent}return{left:left,top:top}},mousePosition:function mousePosition(dom,event){var bounding=dom.getBoundingClientRect();if(!event||!event.clientX)throw new Error("Event is necessary!");return{x:event.clientX-bounding.left,y:event.clientY-bounding.top}},remove:function remove(dom){dom.parentNode.removeChild(dom)},setStyles:function setStyles(dom,styles){for(var key in styles){dom.style[key]=styles[key]}},size:function size(dom,type){var elemHeight,elemWidth;if(type=="content"){elemWidth=dom.clientWidth-(this.getStyle(dom,"padding-left")+"").replace("px","")-(this.getStyle(dom,"padding-right")+"").replace("px","");elemHeight=dom.clientHeight-(this.getStyle(dom,"padding-top")+"").replace("px","")-(this.getStyle(dom,"padding-bottom")+"").replace("px","")}else if(type=="padding"){elemWidth=dom.clientWidth;elemHeight=dom.clientHeight}else if(type=="border"){elemWidth=dom.offsetWidth;elemHeight=dom.offsetHeight}else if(type=="scroll"){elemWidth=dom.scrollWidth;elemHeight=dom.scrollHeight}else{elemWidth=dom.offsetWidth;elemHeight=dom.offsetHeight}return{width:elemWidth,height:elemHeight}},append:function append(el,template){var node=this.isNode(template)?template:this.toNode(template);el.appendChild(node);return node},prepend:function prepend(el,template){var node=this.isNode(template)?template:this.toNode(template);el.insertBefore(node,el.childNodes[0]);return node},after:function after(el,template){var node=this.isNode(template)?template:this.toNode(template);el.parentNode.insertBefore(node,el.nextSibling);return node},before:function before(el,template){var node=this.isNode(template)?template:this.toNode(template);el.parentNode.insertBefore(node,el);return node}};var helpHidden=null;function calcSize(texts){if(!helpHidden){helpHidden=xhtml.toNode("<div></div>");xhtml.setStyles(helpHidden,{"font-size":config.mathFormula["font-size"]+"px","font-family":"sans-serif",padding:"0",border:"none",position:"fixed",bottom:"-100px"});xhtml.append(document.body,helpHidden)}helpHidden.innerText=texts;return xhtml.size(helpHidden)}var toString=Object.prototype.toString;function getType(value){if(value==null){return value===undefined?"[object Undefined]":"[object Null]"}return toString.call(value)}function _isNumber(value){return typeof value==="number"||value!==null&&_typeof(value)==="object"&&getType(value)==="[object Number]"}function _isString(value){var type=_typeof(value);return type==="string"||type==="object"&&value!=null&&!Array.isArray(value)&&getType(value)==="[object String]"}var isNumber=_isNumber;var isString=_isString;var formatBasic=function formatBasic(p1){if(isString(p1)||isNumber(p1)){var contentSize=calcSize(p1);return{width:contentSize.width+config.mathFormula["padding-size"]*2,height:contentSize.height+config.mathFormula["padding-size"]*2,contents:[p1],type:"string"}}else{return p1}};var helpSize={};var getContentSize=function getContentSize(p1){if(!(p1 in helpSize)){helpSize[p1]=calcSize(p1)}return helpSize[p1]};var mathFormula={gen:function gen(p1){var p1Obj=formatBasic(p1);return{width:p1Obj.width+5+config.mathFormula["padding-size"]*2,height:p1Obj.height+config.mathFormula["padding-size"]*2,contents:[p1Obj],type:"gen"}},limt:function limt(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);p1Obj.width-=config.mathFormula["padding-size"]*2;p1Obj.height-=config.mathFormula["padding-size"]*2;var limtSize=getContentSize("limt");var leftHeight=limtSize.height+p1Obj.height*2;return{width:p1Obj.width+p2Obj.width+config.mathFormula["padding-size"]*2,height:(leftHeight>p2Obj.height?leftHeight:p2Obj.height)*.5+p2Obj.height*.5,contents:[p1Obj,p2Obj],type:"limt",_help:{limtSize:limtSize,leftWidth:p1Obj.width}}},sum:function sum(p1,p2,p3){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);var p3Obj=formatBasic(p3);var leftWidth=Math.max(p1Obj.width,p2Obj.width,20);return{width:leftWidth+p3Obj.width+config.mathFormula["padding-size"]*2,height:Math.max(Math.max(p1Obj.height,p2Obj.height)*2+20,p3Obj.height)+config.mathFormula["padding-size"]*2,contents:[p1Obj,p2Obj,p3Obj],type:"sum",_help:{leftWidth:leftWidth,p1Height:p1Obj.height,p1Width:p1Obj.width,p2Height:p2Obj.height,p2Width:p2Obj.width,rightHeight:p3Obj.height}}},join:function join(){var pxObjs=[],width=0,height=0;for(var _len=arguments.length,px=new Array(_len),_key=0;_key<_len;_key++){px[_key]=arguments[_key]}for(var _i=0,_px=px;_i<_px.length;_i++){var p=_px[_i];var pxObj=formatBasic(p);pxObjs.push(pxObj);width+=pxObj.width;height=pxObj.height>height?pxObj.height:height}return{width:width+config.mathFormula["padding-size"]*2,height:height+config.mathFormula["padding-size"]*2,contents:pxObjs,type:"join"}},matrix:function matrix(p1,p2){var pxObjs=[];var rowMax=[],colMax=[];for(var i in p1){rowMax[i]=0}for(var j in p1[0]){colMax[j]=0}for(var _i2 in p1){var rowPxObjs=[],row=p1[_i2];for(var _j in row){var col=row[_j];var colPxObj=formatBasic(col);rowPxObjs.push(colPxObj);if(rowMax[_i2]<colPxObj.height)rowMax[_i2]=colPxObj.height;if(colMax[_j]<colPxObj.width)colMax[_j]=colPxObj.width}pxObjs.push(rowPxObjs)}var width=0,height=0;for(var _i3=0,_rowMax=rowMax;_i3<_rowMax.length;_i3++){var value=_rowMax[_i3];height+=value}for(var _i4=0,_colMax=colMax;_i4<_colMax.length;_i4++){var _value=_colMax[_i4];width+=_value}var rowCenter=[],colCenter=[];rowCenter[0]=config.mathFormula["padding-size"]+rowMax[0]*.5;colCenter[0]=config.mathFormula["padding-size"]+colMax[0]*.5+10;for(var _i5=1;_i5<rowMax.length;_i5++){rowCenter[_i5]=rowCenter[_i5-1]+(rowMax[_i5-1]+rowMax[_i5])*.5}for(var _j2=1;_j2<colMax.length;_j2++){colCenter[_j2]=colCenter[_j2-1]+(colMax[_j2-1]+colMax[_j2])*.5}return{width:width+config.mathFormula["padding-size"]*2+20,height:height+config.mathFormula["padding-size"]*2,contents:pxObjs,type:"matrix",_help:{isHLS:p2,rowCenter:rowCenter,colCenter:colCenter}}},division:function division(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);return{width:Math.max(p1Obj.width,p2Obj.width)+config.mathFormula["padding-size"]*2,height:p1Obj.height+p2Obj.height+2+config.mathFormula["padding-size"]*2,contents:[p1Obj,p2Obj],type:"division"}},bracket:function bracket(p1,p2){var p1Obj=formatBasic(p1);return{width:p1Obj.width+20+config.mathFormula["padding-size"]*2,height:p1Obj.height+config.mathFormula["padding-size"]*2,contents:[p1Obj],type:"bracket",_help:{type:p2}}},rightTop:function rightTop(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);return{width:p1Obj.width+p2Obj.width-config.mathFormula["padding-size"]*2,height:p1Obj.height+p2Obj.height-config.mathFormula["padding-size"]*2-5,contents:[p1Obj,p2Obj],type:"rightTop",_help:{p1Width:p1Obj.width,p1Height:p1Obj.height}}},rightBottom:function rightBottom(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);return{width:p1Obj.width+p2Obj.width-config.mathFormula["padding-size"]*2,height:p1Obj.height+p2Obj.height-config.mathFormula["padding-size"]*2-5,contents:[p1Obj,p2Obj],type:"rightBottom",_help:{p1Width:p1Obj.width,p2Height:p2Obj.height}}},equationSet:function equationSet(){var pxObjs=[],width=0,height=0,pxTop=config.mathFormula["padding-size"],pxTops=[];for(var _len2=arguments.length,px=new Array(_len2),_key2=0;_key2<_len2;_key2++){px[_key2]=arguments[_key2]}for(var _i6=0,_px2=px;_i6<_px2.length;_i6++){var p=_px2[_i6];var pxObj=formatBasic(p);pxObjs.push(pxObj);height+=pxObj.height;width=pxObj.width>width?pxObj.width:width;pxTops.push(pxTop);pxTop+=pxObj.height}return{width:width+10+config.mathFormula["padding-size"]*2,height:height+config.mathFormula["padding-size"]*2,contents:pxObjs,type:"equationSet",_help:{pxTops:pxTops}}},upLine:function upLine(p1){var p1Obj=formatBasic(p1);return{width:p1Obj.width,height:p1Obj.height+config.mathFormula["padding-size"],contents:[p1Obj],type:"upLine"}},downLine:function downLine(p1){var p1Obj=formatBasic(p1);return{width:p1Obj.width,height:p1Obj.height+config.mathFormula["padding-size"],contents:[p1Obj],type:"downLine"}},absoluteValue:function absoluteValue(p1){var p1Obj=formatBasic(p1);return{width:p1Obj.width+config.mathFormula["padding-size"]*2,height:p1Obj.height,contents:[p1Obj],type:"absoluteValue"}},integral:function integral(p1,p2){var p3=arguments.length>2&&arguments[2]!==undefined?arguments[2]:"";var p4=arguments.length>3&&arguments[3]!==undefined?arguments[3]:"";var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);var p3Obj=formatBasic(p3);var p4Obj=formatBasic(p4);return{width:Math.max(p1Obj.width+p2Obj.width,p3Obj.width-5,p4Obj.width)+15+config.mathFormula["padding-size"]*2,height:p1Obj.height+p3Obj.height+p4Obj.height+config.mathFormula["padding-size"]*2,contents:[p1Obj,p2Obj,p3Obj,p4Obj],type:"integral"}},listedOr:function listedOr(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);return{width:Math.max(p1Obj.width,p2Obj.width,30)+config.mathFormula["padding-size"]*2,height:p1Obj.height+p2Obj.height+35+config.mathFormula["padding-size"]*2,contents:[p1Obj,p2Obj],type:"listedOr"}},listedAnd:function listedAnd(p1,p2){var p1Obj=formatBasic(p1);var p2Obj=formatBasic(p2);return{width:Math.max(p1Obj.width,p2Obj.width,30)+config.mathFormula["padding-size"]*2,height:p1Obj.height+p2Obj.height+35+config.mathFormula["padding-size"]*2,contents:[p1Obj,p2Obj],type:"listedAnd"}}};quickPaper_min.directive("kpMathFormula",kpMathFormula);quickPaper_min.prototype.$mathFormula=mathFormula;export default quickPaper_min;